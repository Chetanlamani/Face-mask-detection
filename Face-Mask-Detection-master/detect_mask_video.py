...
model_path = r"D:\Face-Mask-Detection-master\mask_detector.model"
...
while True:
    ...
    if key==ord('c'):
        cv2.imwrite("D:/Face-Mask-Detection-master/Face-Mask-Detection-master/images/images{}.jpg".format(i), frame)
        i+=1
